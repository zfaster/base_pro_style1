...
<body onload="init()">
	<center>
		<form
			action='${actionPath}!saveCardMoney'
...
<TABLE class="tableEdit" border="0" cellspacing="1" cellpadding="0"
				...
				<TBODY>
					<TR>
						<!-- 这里是添加、编辑界面的标题 -->
						<td align="center" class="tdEditTitle">一卡通充值</TD>
					</TR>
					<TR>
						<td>
							...
							<table class="tableEdit" style="width:600px;" cellspacing="0"
								...
								<tr>
									...
									<td class="tdEditContent">
										<input type="text" name="object.card.no" readonly="readonly" value="${object.card.no }">

									</td>
								</tr>
								<tr>
									<td class="tdEditLabel">充值金额</td>
									<td class="tdEditContent">
										<input type="text" name="money" notNull="true" label="充值金额" >元
									</td>
								</tr>
							</table> <!-- 主输入域结束 --></td>
					</TR>
