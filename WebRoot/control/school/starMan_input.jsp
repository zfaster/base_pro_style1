...
<TABLE class="tableEdit" border="0" cellspacing="1" cellpadding="0"
				...
				<TBODY>
					<TR>
						<!-- 这里是添加、编辑界面的标题 -->
						<td align="center" class="tdEditTitle">风采人物</TD>
					</TR>
					<TR>
						<td>
							...
							<table class="tableEdit" style="width:600px;" cellspacing="0"
								...
								<tr>
									...
									<td class="tdEditContent">
										...
										<input type="text" name="object.name" value="${object.name}" notNull="true" lable="名称" />
									</td>
								...
								<tr>
									<td class="tdEditLabel">身份</td>
									<td class="tdEditContent">

										<input type="text" name="object.type" value="${object.type}" notNull="true" lable="身份" />
									</td>
									<td class="tdEditLabel">简介</td>
									<td class="tdEditContent" colspan="3">
										<textarea rows="5" cols="45" name="object.intro">${object.intro }</textarea>
										</td>
								</tr>
							</table> <!-- 主输入域结束 --></td>
					</TR>
