...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="94%" ><span class="STYLE1"> 新闻列表</span></td>
              </tr>
            </table></td>
  ...
  <tr>
  	<td>
  		<form action="control/school/article" method="get">
  		<table width="100%" border="0" cellspacing="0" cellpadding="0">
  			<tr>
  				<td align="right">标题：</td>
  				<td width="160px"><input type="text" name="title" value="<s:property value="title"/>"></td>
  ...
  <tr>
    <td height="30">
		<jsp:include page="/control/common/pager.jsp">
			<jsp:param name="url" value="control/school/article"/>
